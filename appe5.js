...
function Exercise(name, nsets, nreps, weight) {
    this.name = name;
    this.nsets = nsets;
    this.nreps = nreps;
    this.weight = weight;
...
UI.prototype.addExerciseToList = function (exercise) {
...
// Delete exercise
UI.prototype.deleteExercise = function(target) {
...
// Display Exercises
Store.displayExercises = function() {
...
// Add Exercise
Store.addExercise = function(exercise) {
    const exercises = Store.getExercises();
...
// Remove Exercise
Store.removeExercise = function(name, nsets, nreps, weight) {
    const exercises = Store.getExercises();
